...
module.exports = {
    ...
    buildBargainFinderMax : function(airAvailRQ, blockedAirlines) {
        ...
        var request = merge(buildPOS(airAvailRQ.officeID), buildOriginDestinationInformation(airAvailRQ),
            buildTravelPreferences(blockedAirlines, airAvailRQ),buildTravelerInfoSummary(airAvailRQ),buildTPAExtension(),
...
function buildOriginDestinationInformation(airAvailRQ){
    var dateMonthAsWord = moment("2016-07-19").format('YYYY-MM-DDThh:mm:ss');
    //var sTimestamp = moment("2016-07-19","yyyy-MM-dd'T'hh:mm:ss");
